function openProjectTab(project){
    ...
    var projectTabHtml = '<a href="#" class="project-tab" id="unsaved" project_id="'+ file_id +'" onclick="openCanvasProject(this)" title="Dir:'+ FolderParentName +'/'+ projectName +'">'+
...
$(document).ready(function(){
    ...
    $(".project-tab").eq(0).attr("project_id", project_id);
    setTimeout(() => {
